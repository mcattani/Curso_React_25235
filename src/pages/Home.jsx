...
export default function Home() {
    return (
        <>
            {/* SEO */}
            <Helmet>
                <title>Home | PhoneXpress</title>
                <meta
                    name="description"
                    content="Bienvenido a PhoneXpress, tu tienda online de smartphones al mejor precio."
                />
                <meta
                    name="keywords"
                    content="smartphones, tienda online, PhoneXpress, tecnología, móviles, celulares"
                />
                <meta property="og:title" content="PhoneXpress - Smartphones al mejor precio" />
                <meta
                    property="og:description"
                    content="Explora las mejores ofertas y novedades en tecnología móvil."
                />
